...
Currently there are two ways to test whether this deviation is significant. Chronologically, the first way a simple Chi-squared goodness-of-fit test. In our example, this deviation would be, (50-42)^2/42 + (30-45)^2/45 + (20-23)^2/23 = 6.915. The degrees of freedom for test for Hardy–Weinberg proportions are # genotypes − # alleles, so here is 3-2=1. The 5% significance level for 1 degree of freedom in Chi-squared Distribution is 3.84. Since our χ2 value is  greater than this, it deviates from HWE.
...
The main relevant tag is `HWE` 
 ...
 Here it cited the 2015 Wigginton paper on 
